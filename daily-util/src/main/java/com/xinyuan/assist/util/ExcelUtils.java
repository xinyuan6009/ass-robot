...
public class ExcelUtils {
     ...
     */
    public static List<List<List<String>>> readExcel(String filepath, Integer sheetNo, Integer cellNo)
            throws EncryptedDocumentException, InvalidFormatException, IOException {
        List<List<List<String>>> sheetContents = new ArrayList<>();
        ...
        if (workbook != null) {
            if (sheetNo == null) {
                ...
                for (int i = 0; i < numberOfSheets; i++) {
                    ...
                    sheetContents.add(readExcelSheet(sheet, cellNo));
                }
            } else {
     ...
     * @param sheetNo  sheet序号,从0开始,如果读取全文sheetNo设置null
     */
    public static List<List<List<String>>> readExcel(InputStream is, Integer sheetNo, Integer cellNo)
            throws EncryptedDocumentException, InvalidFormatException, IOException {
        List<List<List<String>>> sheetContents = new ArrayList<>();
    ...
    private static List<List<String>> readExcelSheet(Sheet sheet, Integer cellNo) {
        ...
        if (sheet != null) {
            ...
            for (int i = 0; i <= rowNos; i++) {// 遍历行
                ...
                if (row != null) {
                    ...
                    if (cellNo != null && cellNo <= columNos) {
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
        List<List<List<String>>> aa = ExcelUtils.readExcel("/Users/melonkid/Downloads/word.xls", 0, 1);
